...
## 🟢 Status — all six screens done (2026-07-15, on `main`)
...
- **EL2 ✅ DONE** — `apps/web/src/routes/PoolInvite.tsx`: officer creates an invite (role + expiry), copy-link. QR render using `QRCode` primitive.
